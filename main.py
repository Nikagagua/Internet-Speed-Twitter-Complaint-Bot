...
class InternetSpeedTwitterBot:
    ...
    def tweet_at_provider(self):
        ...
        time.sleep(2)
        email = self.driver.find_element(By.XPATH, '//*[@id="react-root"]/div/div/div[2]/main/'
                                                   'div/div/div[1]/form/div/div[1]/label/div/div[2]/div/input')
        password = self.driver.find_element(By.XPATH, '//*[@id="react-root"]/div/div/div[2]/'
                                                      'main/div/div/div[1]/form/div/div[2]/label/div/div[2]/div/input')
        ...
        tweet_compose = self.driver.find_element(By.XPATH,
                                                 '//*[@id="react-root"]/div/div/div[2]/main/div/'
                                                 'div/div/div/div/div[2]/div/div[2]/div[1]/div/div/'
                                                 'div/div[2]/div[1]/div/div/div/div/div/div'
        ...
        tweet_button = self.driver.find_element(By.XPATH,
                                                ...
                                                'main/div/div/div/div/div/div[2]/div/'
                                                'div[2]/div[1]/div/div/div/div[2]/div[4]/div/div/div[2]/div[3]')
        tweet_button.click()
        time.sleep(2)
        self.driver.quit()
